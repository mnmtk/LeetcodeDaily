<h2><a href="https://leetcode.com/problems/equal-tree-partition/editorial/?envType=problem-list-v2&envId=binary-tree">663. Equal Tree Partition</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, return <code>true</code><em> if you can partition the tree into two trees with equal sums of values after removing exactly one edge on the original tree</em>.</p>
