<h2><a href="https://leetcode.com/problems/binary-tree-longest-consecutive-sequence-ii/editorial/?envType=problem-list-v2&envId=binary-tree">549. Binary Tree Longest Consecutive Sequence II</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, return <em>the length of the longest consecutive path in the tree</em>.</p>
