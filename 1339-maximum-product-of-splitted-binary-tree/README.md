<h2><a href="https://leetcode.com/problems/maximum-product-of-splitted-binary-tree/editorial/?envType=problem-list-v2&envId=binary-tree">1465. Maximum Product of Splitted Binary Tree</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, split the binary tree into two subtrees by removing one edge such that the product of the sums of the subtrees is maximized.</p>
